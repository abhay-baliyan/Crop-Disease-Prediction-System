...
dataset=os.path.abspath(os.path.join(current,'..','data','corn'))
...
# ==================== VALIDATION ====================
results=os.path.abspath(os.path.join(current,'..','results','corn'))#to save model's data 
...
torch.save(model.state_dict(),os.path.join(save,"corn.pth"))#save model
