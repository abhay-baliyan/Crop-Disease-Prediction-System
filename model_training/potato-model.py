...
dataset=os.path.abspath(os.path.join(current,'..','data','potato'))
...
# ==================== VALIDATION ====================
results=os.path.abspath(os.path.join(current,'..','results','potato'))#to save model's data 
...
torch.save(model.state_dict(),os.path.join(save,"potato.pth"))#save model
