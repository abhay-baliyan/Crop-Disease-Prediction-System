...
train=os.path.abspath(os.path.join(current,'..','data','wheat','data','train'))
val=os.path.abspath(os.path.join(current,'..','data','wheat','data','val'))
test=os.path.abspath(os.path.join(current,'..','data','wheat','data','test'))
...
# ==================== VALIDATION ====================
results=os.path.abspath(os.path.join(current,'..','results','wheat'))#to save model's data 
...
torch.save(model.state_dict(),os.path.join(save,"wheat.pth"))#save model
