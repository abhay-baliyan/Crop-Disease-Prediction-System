...
dataset=os.path.abspath(os.path.join(current,'..','data','sugarcane','data'))
...
# ==================== VALIDATION ====================
results=os.path.abspath(os.path.join(current,'..','results','sugarcane'))#to save model's data 
...
torch.save(model.state_dict(),os.path.join(save,"sugarcane.pth"))#save model
